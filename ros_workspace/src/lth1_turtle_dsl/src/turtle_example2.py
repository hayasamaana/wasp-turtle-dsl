...
if __name__ == '__main__':
	...
	waypoints = {"bot_start_at":(1,1), "W0":(1,1), "W1":(1,3), "Frankfurt":(10,1), "Berlin":(3,10), "C1":(6,5), "C2":(10,5), "C3":(6,2), "C4":(2,8), "C5":(3,7) }
	missions = [["DeliveryRoute1",[["LineTask", ["W1", "Berlin"]], ["ShortestPathTask", ["C1", "C2", "C3", "C4"]], ["ReturnToStartTask", []]]], ["DeliveryRoute2",[["LineTask", ["Frankfurt"]], ["ShortestPathTask", ["C1", "C5", "C3"]], ["LineTask", ["Berlin"]], ["ReturnToStartTask", []]]]]
